...
filtered_df = df[df['text'].str.contains('president')]
...
# filtered_df["president
#_frequency"] = filtered_df['text'].str.count('president
#e')

# # Get the raw frequency by summing up the counts from all rows
# raw_frequency = filtered_df['president
#_frequency'].sum()

# freq_by_date = filtered_df.groupby('date')['president
#_frequency'].sum()
...
plt.xlabel('Date')
plt.ylabel('Frequency of the word "president"')
plt.title(' Raw frequency of the word "president"')
plt.show()
...
plt.title(' Raw frequency of the word "president" according to Linear regression')
plt.legend()
plt.show()


## Observation of the trigram "the president
...
tri_grams_block_1 = [tri for doc in block1["tokens"] for tri in nltk.ngrams(doc, 3) if (("the","president", "is") == tri) or (("the","president", "is") == tri)]
tri_grams_block_2 = [tri for doc in block2["tokens"] for tri in nltk.ngrams(doc, 3) if (("the","president", "is") == tri) or (("the","president", "is") == tri)]
tri_grams_block_3 = [tri for doc in block3["tokens"] for tri in nltk.ngrams(doc, 3) if (("the","president", "is") == tri) or (("the","president", "is") == tri)]
tri_grams_block_4 = [tri for doc in block4["tokens"] for tri in nltk.ngrams(doc, 3) if (("the","president", "is") == tri) or (("the","president", "is") == tri)]
...
#Print all occurrences of the tri-gram "le president
...
#find the adjectifve after le president
#e est
...
# Print the five most common word uses of the tri-gram "le president
#e est" in each block
print("Block 1 (1840-1860):")
...
### Occurences of  the two grams before and after “ president
#  ”
...
with open("two-grams-output_president_us.txt", "w") as file:
    # Write the two-grams before "president
    #"
    file.write("-------------------------BLOCK_1-----------------------Two-grams before 'president':\n")
    for two_gram in two_grams_block_1_before:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
    # Write the two-grams after "president
    #"
    file.write("-------------------------BLOCK_1-----------------------Two-grams after 'president':\n")
    for two_gram in two_grams_block_1_after:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")

# Print all occurrences of the tri-gram "l'avenir" in block of tokenized text
print("Block 1 (1840-1860): \n")
print(f"2-grams before 'le president': \n")
print(two_grams_block_1_before, "\n")
print(f"2-grams after 'le president': \n")
...
with open("two-grams-output_president_us.txt", "a") as file:
    # Write the two-grams before "president
    #"
    file.write("-------------------------BLOCK_2-----------------------Two-grams before 'president':\n")
    for two_gram in two_grams_block_2_before:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
    # Write the two-grams after "president
    #"
    file.write("-------------------------BLOCK_2-----------------------Two-grams after 'president':\n")
...
with open("two-grams-output_president_us.txt", "a") as file:
    # Write the two-grams before "president
    #"
    file.write("-------------------------BLOCK_3-----------------------Two-grams before 'president':\n")
    for two_gram in two_grams_block_2_before:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
    # Write the two-grams after "president
    #"
    file.write("-------------------------BLOCK_3-----------------------Two-grams after 'president':\n")
    for two_gram in two_grams_block_2_after:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
...
with open("two-grams-output_president_us.txt", "a") as file:
    # Write the two-grams before "president
    #"
    file.write("-------------------------BLOCK_4-----------------------Two-grams before 'president':\n")
    for two_gram in two_grams_block_2_before:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
    # Write the two-grams after "president
    #"
    file.write("-------------------------BLOCK_4-----------------------Two-grams after 'president':\n")
    for two_gram in two_grams_block_2_after:
        file.write(f"{two_gram[0]} {two_gram[1]}\n")
...
### A concordance analysis can help us identify the contexts in which the word 'president
...
with open("key-word-in-context-president_us.txt ", "w") as file :
    file.write("----------------------BLOCK-1-------------------------- \n")
    for line in text_block_1.concordance_list("president", lines=22):
        file.write(line.line + "\n")
    file.write("----------------------BLOCK-2-------------------------- \n")
    for line in text_block_2.concordance_list("president", lines=800):
        file.write(line.line + "\n")
    file.write("----------------------BLOCK-3-------------------------- \n")
    for line in text_block_3.concordance_list("president", lines=800):
        file.write(line.line + "\n")
    file.write("----------------------BLOCK-4-------------------------- \n")
    for line in text_block_4.concordance_list("president", lines=800):
        file.write(line.line + "\n")
    

# Perform a concordance analysis for the word "president
#" in each block
print("Concordance analysis for 'president' in Block 1:")
text_block_1.concordance("president")
print("\nConcordance analysis for 'president' in Block 2:")
text_block_2.concordance("president")
print("\nConcordance analysis for 'president' in Block 3:")
text_block_3.concordance("president")
print("\nConcordance analysis for 'president' in Block 4:")
text_block_4.concordance("president")
